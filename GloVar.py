def init():
    ...
    global P1AtkSelID, P1AtkSelected, P1AtkType, P1AtkPower, P1AtkEffect, P1EffectActivate, P1DiceType
    global P2AtkSelID, P2AtkSelected, P2AtkType, P2AtkPower, P2AtkEffect, P2EffectActivate, P2DiceType
